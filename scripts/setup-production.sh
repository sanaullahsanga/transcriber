...
echo "  3. Configure Nginx: sudo cp deploy/nginx.conf /etc/nginx/sites-available/transcriber.sangahub.com"
echo "                     sudo ln -sf /etc/nginx/sites-available/transcriber.sangahub.com /etc/nginx/sites-enabled/"
echo "                     sudo nginx -t && sudo systemctl reload nginx"
echo "  4. Enable HTTPS:   sudo certbot --nginx -d transcriber.sangahub.com"
echo
